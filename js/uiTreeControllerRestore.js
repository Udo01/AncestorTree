...
//    	if(this.config.imageShow)$("#imageShowCB").attr ("checked", "checked").checkboxradio ("refresh");
//    	else $("#imageShowCB").attr ("checked", "").checkboxradio ("refresh");
	}
...
uiTreeController.prototype.loadImages=function(){
	st.graph.eachNode(function(node) {
        ...
        if( portraitpicture != "" && thisTreeCtr.getImage(node.id)==null ){
            ...
            img.src="imageservice?img="+portraitpicture+"&t="+thisTreeCtr.config.imageResolution;
        }
        });	
}
