...
GAEDataController = function (page) {
	this.config = {
			val1:null,
	}
	...
	//this.loginservice="http://ancestor-tree.appspot.com/loginservice";	
	this.dataservice="/dataservice";
	//this.dataservice="http://ancestor-tree.appspot.com/dataservice";
}
...
GAEDataController.prototype.showUI=function(){
		...
		$(this.content).empty();
            var contentString="<div>";
                ...
                // if(dataContainer!=null)contentString+=this.addDataContainerHeader(dataContainer);

                // login
                contentString+=this.addLoginContainer();
...
GAEDataController.prototype.addLoginContainer=function()
{
    var str='';
	if(gaeObj.login.loggedIn)
    {	
    ...
    '<a data-ajax="false" href="'+gaeObj.loginURL+'" data-theme="c">'+ctr.getPageResource("home","logout")+'</a>'+
    '</div>';
    }
	else
    {	
    ...
    '<a data-ajax="false" href="'+gaeObj.loginURL+'" data-theme="c">'+ctr.getPageResource("home","login")+'</a>'+
    '</div>';
    }
    return str;
}
